...
"XXOOOOOOOOXX",
"XXppppOpppXX",
"XXrObqkbnrXX","XXXXXXXXXXXX","XXXXXXXXXXXX","K1Q1","k1q1","en0O","tw"]
...
def interpret(a):
    ...
    return(str(index[int(a[1])-2])+str((int(a[0])-1))+str(index[int(a[3])-2])+str(int(a[2])-1))
